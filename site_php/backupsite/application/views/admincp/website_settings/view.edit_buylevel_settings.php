<div id="content" class="span10">
    <div>
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo $this->config->base_url; ?>admincp/manage-settings/buylevel">BuyLevel Settings</a>
            </li>
        </ul>
    </div>
    <div class="row-fluid">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="payment_type" name="payment_type" required>
                                            <option value="1" <?php if(isset($b_config['payment_type']) && $b_config['payment_type'] == 1): echo 'selected="selected"'; endif; ?>>
                                                Credits 1
                                            </option>
                                            <option value="2 "<?php if(isset($b_config['payment_type']) && $b_config['payment_type'] == 2): echo 'selected="selected"'; endif; ?>>
                                                Credits 2
                                            </option>
                                        </select>
