<div id="content" class="span10">
    ...
    <div class="row-fluid">
        <div class="span12">
            <p class="left">
                <a href="<?php echo $this->config->base_url; ?>admincp/add-reset-settings"
                                                    ...
                                                    <tr id="reset-<?php echo $key; ?>-<?php echo $server; ?>">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a class="btn btn-primary"
                                                               href="<?php echo $this->config->base_url; ?>admincp/edit-reset-settings/<?php echo $key; ?>/<?php echo $server; ?>">
                                                                <i class="icon-edit icon-white"></i>
                                                                Edit
                                                            </a>
															<?php if(defined('CUSTOM_RESET_REQ_ITEMS') && CUSTOM_RESET_REQ_ITEMS == true){ ?>
															<a class="btn btn-inverse"
                                                               href="<?php echo $this->config->base_url; ?>admincp/edit-reset-items/<?php echo $key; ?>/<?php echo $server; ?>">
                                                                <i class="icon-edit icon-white"></i>
                                                                Req Items
                                                            </a>
															<?php } ?>
