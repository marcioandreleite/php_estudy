<div id="content" class="span10">
    <div>
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo $this->config->base_url; ?>admincp/warehouse-editor">Warehouse Editor</a></li>
        </ul>
    </div>
    <div class="row-fluid">
        <div class="box span12">
            ...
            <div class="box-content">
                ...
                <form class="form-horizontal" method="post"
                      action="<?php echo $this->config->base_url; ?>admincp/warehouse-editor">
                    <fieldset>
                        <legend></legend>
    ...
    <?php if($show_vault){ ?>
        <div class="row-fluid">
            <div class="box span5">
                ...
                <div class="box-content">
                    <?php
                        $wh_content = '<div style="float:left;width: 261px; margin:2px auto; padding-top:6px; padding-left:3px; height:485px; background-image: url(' . $this->config->base_url . 'assets/default_assets/images/wh.jpg)" id="wh_content">' . "\n";
                        for($i = 1; $i <= 120; $i++){
                            if(isset($items[$i])){
                                $wh_content .= '<div id="item-slot-' . $i . '" class="square" style="margin-top:' . ($items[$i]['yy'] * 32) . 'px; margin-left:' . ($items[$i]['xx'] * 32) . 'px; position:absolute; width:' . ($items[$i]['x'] * 32) . 'px; cursor:pointer; background-image: url(' . $this->config->base_url . 'assets/default_assets/images/wh_root_on.png); height:' . ($items[$i]['y'] * 32) . 'px;" data-info="' . $items[$i]['hex'] . '"><img width="100%" height="100%" alt="' . $items[$i]['name'] . '" src="' . $this->itemimage->load($items[$i]['item_id'], $items[$i]['item_cat'], $items[$i]['level'], 0) . '" /></div>' . "\n";
                            } else{
                        ...
                        echo $wh_content;
                        if($total_items > 120){
                            $wh_content2 = '<div style="float:right;width: 261px; margin:2px auto; padding-top:6px; padding-left:3px; height:485px; background-image: url(' . $this->config->base_url . 'assets/default_assets/images/wh.jpg)" id="wh_content">' . "\n";
                            for($i = 121; $i <= 240; $i++){
                                if(isset($items[$i])){
                                    $wh_content2 .= '<div id="item-slot-' . $i . '" class="square" style="margin-top:' . ($items[$i]['yy'] * 32) . 'px; margin-left:' . ($items[$i]['xx'] * 32) . 'px; position:absolute; width:' . ($items[$i]['x'] * 32) . 'px; cursor:pointer; background-image: url(' . $this->config->base_url . 'assets/default_assets/images/wh_root_on.png); height:' . ($items[$i]['y'] * 32) . 'px;" data-info="' . $items[$i]['hex'] . '"><img width="100%" height="100%" alt="' . $items[$i]['name'] . '" src="' . $this->itemimage->load($items[$i]['item_id'], $items[$i]['item_cat'], $items[$i]['level'], 0) . '" /></div>' . "\n";
                                } else{
