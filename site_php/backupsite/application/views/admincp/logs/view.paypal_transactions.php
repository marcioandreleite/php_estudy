<div id="content" class="span10">
    <div>
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo $this->config->base_url; ?>admincp/logs-paypal-transactions">Paypal Transactions</a>
            </li>
        </ul>
    </div>
    <?php
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <div class="input-append">
                                ...
                                <button class="btn" type="submit" name="search_paypal_transactions">Search</button>
                            </div>
                        </div>
                    </div>
                </form>
                ...
                <?php
                    if(isset($logs) && !empty($logs)):
                        ...
                        <table class="table">
							...
							<td class="center">' . $value['payer_email'] . '</td>
						  </tr>';
                                }
                            ?>
                            </tbody>
