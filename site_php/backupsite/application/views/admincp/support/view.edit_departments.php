<div id="content" class="span10">
    <div>
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo $this->config->base_url; ?>admincp/support-departments">Support Departments</a></li>
        </ul>
    </div>
    <?php
        if(isset($error)){
            ...
            <div class="row-fluid">
                <div class="box span12">
                    <div class="box-header well">
                        <h2><i class="icon-edit"></i> Edit Departments</h2>
                    </div>
                        ...
                        <form class="form-horizontal" method="POST" action="">
                            <fieldset>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="typeahead" id="title" name="title"
                                               value="<?php if(isset($data['department_name'])){
                                        ...
                                        <select id="server" name="server">
                                            ...
                                            <?php
                                                foreach($this->website->server_list() as $key => $value){
                                                    if(isset($data['server']) && $data['server'] == $key){
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="typeahead" id="pay_per_incident" name="pay_per_incident"
                                               value="<?php if(isset($data['pay_per_incident'])){
                                                   echo $data['pay_per_incident'];
                                               } else{
                                                   echo 0;
                                               } ?>"/>
                                    </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="payment_type" name="payment_type">
                                            <option
                                                    value="1" <?php if(isset($data['payment_type']) && $data['payment_type'] == 1){
                                                echo 'selected="selected"';
                                            } ?>>Credits 1
                                            </option>
                                            <option
                                                    value="2" <?php if(isset($data['payment_type']) && $data['payment_type'] == 2){
                                                echo 'selected="selected"';
                                            } ?>>Credits 2
                                            </option>
                                        </select>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select id="status" name="status">
                                            <option
                                                    value="1" <?php if(isset($data['is_active']) && $data['is_active'] == 1){
                                                echo 'selected="selected"';
                                            } ?>>Active
                                            </option>
                                            <option
                                                    value="0" <?php if(isset($data['is_active']) && $data['is_active'] == 0){
                                                echo 'selected="selected"';
                                            } ?>>Inactive
                                            </option>
                                        </select>
                                ...
                                <div class="form-actions">
                                    <button type="submit" name="edit_department" class="btn btn-primary">Edit Department
                                    </button>
                                </div>
                            </fieldset>
                        </form>
