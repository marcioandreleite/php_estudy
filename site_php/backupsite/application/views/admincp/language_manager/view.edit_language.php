<div id="content" class="span10">
    <div>
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo $this->config->base_url; ?>admincp/languages">List Languages</a></li>
        </ul>
    </div>
    <div class="row-fluid">
        <div class="box span9">
            ...
            <div class="box-content">
                <form role="form" name="new_language_string" id="new_language_string" method="POST" action="<?php echo $this->config->base_url;?>admincp/add-string">
	...
	<script>
	  $(document).ready(function(){
		...
		$(document).on("input",'input[id^="langstring*"]', function (){
		  ...
		  $.ajax({
			type: 'POST',
			url: '<?php echo $this->config->base_url; ?>admincp/edit-string',
