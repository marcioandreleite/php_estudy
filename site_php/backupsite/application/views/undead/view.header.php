...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=AW-11194670778">
</script>
<script>
				...
				<div class="header-wrapper-menu">
					...
					<div class="header-wrapper_right">
						<ul class="header-menu">
							...
							<li><a href="<?php echo $this->config->base_url; ?>drop"><?php echo __('Drops');?></a></li>
							<!--<li><a href="https://discord.gg/rjWG6aYkTE"><?php echo __('DropList');?></a></li>-->
