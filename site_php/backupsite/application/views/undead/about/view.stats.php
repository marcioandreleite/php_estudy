			...
			<div class="row mt-1">
				<div class="col-12">     
					<table class="table dmn-rankings-table table-striped">
                        <thead>
							<tr>
								<th colspan="10"> <?php echo __('<center>Server Info</center>'); ?></th>
							</tr>
                        </thead>
                        <tbody>
							<tr>
								<td style="width:50%;text-align: left;"><?php echo __('Version'); ?></td>
								<td style="width:50%;text-align: left;"><?php echo __('Season 18 Part 1~3'); ?></td>
							</tr>
							<tr>
								<td style="width:50%;text-align: left;"><?php echo __('Exp'); ?></td>
								<td style="width:50%;text-align: left;"><?php echo __('75x'); ?></td>
							</tr>
							<tr>
								<td style="width:50%;text-align: left;"><?php echo __('Master Exp'); ?></td>
								<td style="width:50%;text-align: left;"><?php echo __('30x'); ?></td>
							</tr>
							<tr>
								<td style="width:50%;text-align: left;"><?php echo __('Majestic Exp'); ?></td>
								<td style="width:50%;text-align: left;"><?php echo __('30x'); ?></td>
							</tr>
							<tr>
								<td style="width:50%;text-align: left;"><?php echo __('Reset'); ?></td>
								<td style="width:50%;text-align: left;"><?php echo __('Off'); ?></td>
							</tr>
							<tr>
								<td style="width:50%;text-align: left;"><?php echo __('Exp type'); ?></td>
								<td style="width:50%;text-align: left;"><?php echo __('Dynamic'); ?></td>
							</tr>
                        </tbody>
                    </table>
				</div>	
			...
			<div class="row mt-1">
				<div class="col-12">     
					<table class="table dmn-rankings-table table-striped">
                        <thead>
							<tr>
							<th colspan="10"> <?php echo __('<center>Chaos Machine Item Level UP - VIP +10%</center>'); ?></th>
							</tr>
                        </thead>
                        <tbody>
							<tr>
								<td style="width:20%;text-align: left;"><?php echo __('Regular'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('50%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('50%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('40%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('40%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('30%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('20%'); ?></td>
							</tr>
							<tr>
								<td style="width:20%;text-align: left;"><?php echo __('Ancient'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('50%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('40%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('30%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('20%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('15%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('10%'); ?></td>
							</tr>
							<tr>
								<td style="width:20%;text-align: left;"><?php echo __('Socket'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('50%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('40%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('30%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('20%'); ?></td>
							...
							<tr>
								<td style="width:20%;text-align: left;"><?php echo __('Pentagram'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('50%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('45%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('40%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('35%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('30%'); ?></td>
								<td style="width:13%;text-align: left;"><?php echo __('25%'); ?></td>
							</tr>
                        </tbody>
                    </table>
				</div>	
			...
			<div class="row mt-1">
				<div class="col-12">     
					<table class="table dmn-rankings-table table-striped">
                        <thead>
							<tr>
							<th colspan="13"> <?php echo __('<center>Errtel Level UP - VIP +10%</center>'); ?></th>
							</tr>
                        </thead>
                        <tbody>
							<tr>
								<td style="width:20%;text-align: center;"><?php echo __('Errtel Rank Option'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('85%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('80%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('75%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('70%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('65%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('60%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('55%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('50%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('45%'); ?></td>
							</tr>
							<tr>
								<td style="width:20%;text-align: center;"><?php echo __('Wings Option Level UP'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('95%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('90%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('85%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('80%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('75%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('70%'); ?></td>
								...
								<td style="width:2%;text-align: left;"><?php echo __('50%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('45%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('40%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('35%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('30%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('25%'); ?></td>
							</tr>
							<tr>
								<td style="width:20%;text-align: left;"><?php echo __('Earring Level UP'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('95%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('90%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('85%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('80%'); ?></td>
							...
							<tr>
								<td style="width:20%;text-align: left;"><?php echo __('Enhanced Elemental Option'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('65%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('65%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('65%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('60%'); ?></td>
							...
							<tr>
								<td style="width:20%;text-align: left;"><?php echo __('Master Errtel Rank Option'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('95%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('90%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('85%'); ?></td>
								<td style="width:2%;text-align: left;"><?php echo __('80%'); ?></td>
			...
			<!-- Fim Novo 2 -->
				...
				<div class="col-12">     
					<table class="table dmn-rankings-table table-striped">
                        <thead>
							<tr>
							<th colspan="10"> <?php echo __('<center>Wings Creation - VIP +10%</center>'); ?></th>
							</tr>
                        </thead>
                        <tbody>
							<tr>
								<td style="width:50%;text-align: left;"><?php echo __('Wings Lv2'); ?></td>
								<td style="width:50%;text-align: left;"><?php echo __('90%'); ?></td>
							</tr>
							<tr>
								<td style="width:50%;text-align: left;"><?php echo __('Wings Lv2.5'); ?></td>
								<td style="width:50%;text-align: left;"><?php echo __('60%'); ?></td>
							</tr>
							<tr>
								<td style="width:50%;text-align: left;"><?php echo __('Wings Lv3'); ?></td>
								<td style="width:50%;text-align: left;"><?php echo __('35%'); ?></td>
							</tr>
							<tr>
								<td style="width:50%;text-align: left;"><?php echo __('Wings Lv4'); ?></td>
								<td style="width:50%;text-align: left;"><?php echo __('30%'); ?></td>
							</tr>
                        </tbody>
                    </table>
				</div>	
