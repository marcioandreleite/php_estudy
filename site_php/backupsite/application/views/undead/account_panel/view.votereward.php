										...
										if($links['voted'] == 1){
											$html .= '<ul id="vote-options">
															<li>
																...
																<button class="float-right btn btn-primary" style="border:0px;" id="vote-' . $links['id'] . '-' . $links['reward_type'] . '" value="' . $links['next_vote'] . '" disabled="disabled" data-api="' . $links['api'] . '" data-info="voted">' . $links['next_vote'] . '</button>
															</li>
														</ul>';
										} else{
											$html .= '<ul id="vote-options">
															<li>
																...
																<button class="float-right btn btn-primary" style="border:0px;" id="vote-' . $links['id'] . '-' . $links['reward_type'] . '" data-link="' . $links['link'] . '" data-info="nvoted" value="vote-' . $links['id'] . '">' . __('Vote Now!') . '</button>
															</li>
														</ul>';
										}
									}
