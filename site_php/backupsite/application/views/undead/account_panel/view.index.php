				...
				<div class="col-12"> 
					...
					<div class="tab-content" id="myTabContent">
					  <div class="tab-pane fade show active p-2" id="acc-info" role="tabpanel" aria-labelledby="acc-info-tab">
						<table class="table dmn-account-table table-striped">
							<tr>
							...
							?>
							<tr>
								<td><?php echo $this->website->translate_credits(1, $this->session->userdata(['user' => 'server']));?></td>
								<td><?php echo number_format($credits['credits']); ?></td>
							</tr>
							<tr>
								<td><?php echo $this->website->translate_credits(2, $this->session->userdata(['user' => 'server']));?></td>
							...
							?>
							<tr>
								<td><?php echo __('WCoins'); ?></td>
								<td><?php echo number_format($wcoin); ?></td>
							</tr>
							<?php } ?>
							<tr>
								<td><?php echo __('Member Since'); ?></td>
								<td>
									<?php 
					  ...
					  <div class="tab-pane fade p-2" id="user-services" role="tabpanel" aria-labelledby="user-services-tab">
						<table class="table dmn-account-table table-striped">
							...
							<tr>
								...
								<td><?php echo __('Exchange Wcoins to credits'); ?></td>
