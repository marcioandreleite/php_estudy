		...
		<div class="dmn-page-content">
			...
			<div class="row">
				<div class="col-12">     
					...
					<input type="text" value="<?php echo $this->config->base_url; ?>registration/index/<?php echo $this->session->userdata(['user' => 'id']); ?>/<?php echo $this->session->userdata(['user' => 'server']); ?>" class="form-control" onclick="select(this);"/>
				</div>	
			</div>	
			<div class="row mt-4">
				<div class="col-12">     
                                                    ...
                                                    <td>
                                                        <?php
                                                            if(!empty($ref_rewards)){
                                                                ...
                                                                $html = '<div class="ref-reward-dropdown"><button class="btn btn-primary">' . __('View Reward List') . '</button><div class="ref-reward-dropdown-content">';
                    ...
                    <div id="ucp_info">
                        <div class="full">
                            <table width="99%" style="padding:3px;">
                                <tr>
                                    <td><input type="text" value="<?php echo $this->config->base_url; ?>registration/index/<?php echo $this->session->userdata(['user' => 'id']); ?>/<?php echo $this->session->userdata(['user' => 'server']); ?>" class="text" style="width: 100%;" onclick="select(this);"/></td>
                                </tr>
                            </table>
                        </div>
                    </div>
