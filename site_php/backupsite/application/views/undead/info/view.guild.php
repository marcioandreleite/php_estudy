			...
			<div class="row">
				<div class="col-12">     
                    ...
                    ?>
								...
								<tr>
									...
									<td style="width: 70%;">
										<table style="width:100%;margin: 0 auto;">
											...
											<tr>
												<td style="width:50%;text-align: left;"><?php echo __('Country'); ?></td>
												<td style="width:50%;text-align: left;"><?php echo $country; ?></td>
											</tr>
										</table>
									</td>
								</tr>
								...
								<tr>
									<td>
										<table style="width:100%;text-align: center;margin: 0 auto;">
											<?php if($hidden == false){ ?>
												<tr>
													<td style="width:40%;text-align: left;padding-left: 15px;"><?php echo __('Characters'); ?>:</td>
											...
											<?php } ?>
											<tr>
												<td style="width:40%;text-align: left;padding-left: 15px;"><?php echo __('Last Login'); ?>:</td>
												<td style="width:60%;text-align: left;padding-left: 15px;">
													<?php
														if($status != false){
											...
											<tr>
												<td style="width:40%;text-align: left;padding-left: 15px;"><?php echo __('Total Votes'); ?></td>
												<td style="width:60%;text-align: left;padding-left: 15px;">
													<?php echo $vote_count; ?>
												</td>
											</tr>
						...
						<?php } ?>
						<?php if($this->config->config_entry('character_' . $args[1] . '|show_equipment') == 1){ ?>
