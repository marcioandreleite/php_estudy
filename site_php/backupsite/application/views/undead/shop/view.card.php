						...
						<form method="POST" name="items_credits" id="items_credits" action="">
							...
							<div style="padding-top:10px;">
								...
								<div class="float-right">
									<button id="buy_items_credits" class="btn btn-primary"><?php echo __('Buy Selected'); ?></button>
								</div>
						...
						?>
							<form method="POST" name="items_gcredits" id="items_gcredits" action="">
								...
								<div style="padding-top:10px;">
									...
									<div class="float-right">
										<button id="buy_items_gcredits" class="btn btn-primary"><?php echo __('Buy Selected'); ?></button>
									</div>
									<div style="clear:both;"></div>
								</div>
							</form>
