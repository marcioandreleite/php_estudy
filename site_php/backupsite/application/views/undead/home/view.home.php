		...
		<div class="col">
			<div class="topSlider home-block">
				...
				<div class="top-slider">
					<div class="top-slide">
						<a href="https://discord.gg/rjWG6aYkTE"><img src="<?php echo $this->config->base_url; ?>assets/<?php echo $this->config->config_entry("main|template"); ?>/images/banner1.png" alt="https://discord.gg/rjWG6aYkTE"></a>
					</div>
					<div class="top-slide">
						<a href="https://discord.gg/rjWG6aYkTE"><img src="<?php echo $this->config->base_url; ?>assets/<?php echo $this->config->config_entry("main|template"); ?>/images/banner2.png" alt="https://discord.gg/rjWG6aYkTE"></a>
					</div>
					<div class="top-slide">
						<a href="https://discord.gg/rjWG6aYkTE"><img src="<?php echo $this->config->base_url; ?>assets/<?php echo $this->config->config_entry("main|template"); ?>/images/banner3.png" alt="https://discord.gg/rjWG6aYkTE"></a>
					</div>
					<div class="top-slide">
						<a href="https://discord.gg/rjWG6aYkTE"><img src="<?php echo $this->config->base_url; ?>assets/<?php echo $this->config->config_entry("main|template"); ?>/images/banner4.png" alt="https://discord.gg/rjWG6aYkTE"></a>
					</div>
					<!--<div class="top-slide">
						<a href="https://discord.gg/rjWG6aYkTE"><img src="<?php echo $this->config->base_url; ?>assets/<?php echo $this->config->config_entry("main|template"); ?>/images/banner.jpg" alt="https://discord.gg/rjWG6aYkTE"></a>
					</div>-->
				</div>
			</div>
			<script>
	...
	<div class="row">
		<div class="col">
			<div class="home-block home-block-top">
				...
				?>
				<div class="more">
					<a href="https://pvpmu.net/rankings?top=players" class="button">View All</a>
				</div>
				<?php } ?>
			</div>
		</div>
		<div class="col">
			<div class="home-block home-block-top">
				...
				?>
				<div class="more">
					<a href="https://pvpmu.net/rankings" class="button">View All</a>
				</div>
				<?php } ?>
			</div>
		</div>
...
<div class="midBlock">
	<div class="row">
		<div class="col">
			...
			<a href="<?php echo $this->config->base_url; ?>guides" class="button mid-block_button"><?php echo __('More');?></a>
			</div>
			...
			<div class="mid-block mid-block-statistics">
				...
				<a href="<?php echo $this->config->base_url; ?>about/stats/PVPMU" class="button mid-block_button"><?php echo __('More');?></a>
			</div>
			<div class="social flex-s">
				<a href="https://www.facebook.com/PvPMuS18" class="socBlock socBlock-facebook">
				...
				<a href="https://www.twitch.tv/" class="socBlock socBlock-twitch">
				...
				<a href="https://discord.gg/rjWG6aYkTE" class="socBlock socBlock-discord">
