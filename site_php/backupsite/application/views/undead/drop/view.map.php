						...
						*, ::before, ::after {
						...
						<?php if(isset($drop_data)){ ?>
							...
							<div class="panel panel-default panel-red-heading">
								<div class="panel-heading"><?php echo $monster;?></div>
								<div class="panel-body">
									<div class="table-responsive">
										...
										<?php foreach($item AS $k => $v){ ?>
											<tr>
												<td><a href="<?php echo $this->config->base_url;?>drop/item/<?php echo $v['name'];?>-c<?php echo $key;?>-i<?php echo $k;?>"><?php echo $v['name'];?></a></td>
											</tr>
										<?php  } ?>
										<?php  } ?>
										</table>
