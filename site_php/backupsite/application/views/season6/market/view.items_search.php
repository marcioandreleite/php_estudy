...
<div id="content">
    <div id="box1">
        ...
        <div class="box-style1" style="margin-bottom: 20px;">
                    ...
                    <?php
                        foreach($this->website->server_list() as $key => $server):
                            if($server['visible'] == 1 && $key != $def_server):
                                ?>
                                <a class="custom_button" href="<?php echo $this->config->base_url; ?>market/index/1/<?php echo $key; ?>"><?php echo $server['title']; ?><?php echo __('Market'); ?></a>
                            <?php
                            endif;
                        endforeach;
                    ?>
            ...
            <div class="entry">
                <div style="float:right;">
                    <a class="custom_button" href="" id="show_filter"><?php echo __('Show Filter'); ?></a>
                    <a class="custom_button" href="<?php echo $this->config->base_url; ?>warehouse"><?php echo __('Warehouse'); ?></a>
                    <a class="custom_button" href="<?php echo $this->config->base_url; ?>warehouse/web"><?php echo __('Web Warehouse'); ?></a>
                    <a class="custom_button" href="<?php echo $this->config->base_url; ?>market/history"><?php echo __('History'); ?></a>
                </div>
                        ...
                        <?php
                            foreach($items as $item):
                                ...
                                <tr style="background-color:<?php echo $color; ?>;">
                                    ...
                                    <td style="background-color:<?php echo $color; ?>;"><span id="market_item_<?php echo $item['pos']; ?>" data-info="<?php echo $item['item']; ?>"><a href="<?php echo $this->config->base_url; ?>market/buy/<?php echo $item['id']; ?>"><?php echo $item['name']; ?></a></span></td>
                ...
                <?php
                    ...
                    ?>
                    <div class="w_note"><?php echo __('No Items Found.'); ?></div>
                <?php
                endif;
                ?>
                        ...
                        <div class="item_filter_content">
                            <?php if(!empty($item_title_list)){ ?>
                                <form method="post" action="">
                                    <label style="font-weight: bold;margin:3px;font-size:12px;"><?php echo __('Search Item'); ?>:</label>
                                    ...
                                    <button class="custom_button" type="submit" value="search_item" name="search_item"><?php echo __('Search'); ?></button>
                                    <br/>
                                </form>
                            <?php } ?>
                            <form method="post" action="">
                                ...
                                <div style="border-bottom:1px solid gray;width: 90%;margin:5px;display:block;"></div>
                                <input type="checkbox" name="luck" value="1" <?php if(isset($_SESSION['filter']['luck'])){
                                    echo 'checked="checked"';
                                } ?>/> <?php echo __('Item Luck'); ?><br/>
                                <input type="checkbox" name="skill" value="1" <?php if(isset($_SESSION['filter']['skill'])){
                                    echo 'checked="checked"';
                                } ?>/> <?php echo __('Item Skill'); ?><br/>
                                <input type="checkbox" name="ancient" value="1" <?php if(isset($_SESSION['filter']['ancient'])){
                                    echo 'checked="checked"';
                                ...
                                <div style="border-bottom:1px solid gray;width: 90%;margin:5px;display:block;"></div>
                                <input type="radio" name="class" value="sm" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'sm'){
                                    echo 'checked="checked"';
                                } ?>/> Wizard<br/>
                                <input type="radio" name="class" value="bk" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'bk'){
                                    echo 'checked="checked"';
                                } ?>/> Knight<br/>
                                <input type="radio" name="class" value="me" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'me'){
                                    echo 'checked="checked"';
                                } ?>/> Elf<br/>
                                <input type="radio" name="class" value="mg" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'mg'){
                                    echo 'checked="checked"';
                                } ?>/> Gladiator<br/>
                                <input type="radio" name="class" value="dl" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'dl'){
                                    echo 'checked="checked"';
                                } ?>/> Lord<br/>
                                <input type="radio" name="class" value="bs" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'bs'){
                                    echo 'checked="checked"';
                                } ?>/> Summoner<br/>
                                <input type="radio" name="class" value="rf" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'rf'){
                                    echo 'checked="checked"';
                                } ?>/> Fighter<br/>
                                <?php if(defined('MU_VERSION') && MU_VERSION >= 5): ?>
                                    <input type="radio" name="class" value="gl" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'gl'){
                                        echo 'checked="checked"';
                                    } ?>/> Lancer<br/>
                                <?php endif; ?>
								<?php if(defined('MU_VERSION') && MU_VERSION >= 9): ?>
                                    <input type="radio" name="class" value="rw" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'rw'){
                                        echo 'checked="checked"';
                                    } ?>/> Rune Wizard<br/>
                                <?php endif; ?>
								<?php if(defined('MU_VERSION') && MU_VERSION >= 10): ?>
                                    <input type="radio" name="class" value="sl" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'sl'){
                                        echo 'checked="checked"';
                                    } ?>/> Slayer<br/>
                                <?php endif; ?>
								<?php if(defined('MU_VERSION') && MU_VERSION >= 11): ?>
                                    <input type="radio" name="class" value="gc" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'gc'){
                                        echo 'checked="checked"';
                                    } ?>/> Crusher<br/>
                                <?php endif; ?>
								<?php if(defined('MU_VERSION') && MU_VERSION >= 12): ?>
                                    <input type="radio" name="class" value="km" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'km'){
                                        echo 'checked="checked"';
                                    } ?>/> White Mage<br/>
									<input type="radio" name="class" value="lm" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'lm'){
                                        echo 'checked="checked"';
                                    } ?>/> Mage<br/>
                                <?php endif; ?>
                                 <?php if(defined('MU_VERSION') && MU_VERSION >= 13): ?>
                                    <input type="radio" name="class" value="ik" <?php if(isset($_SESSION['filter']['class']) && $_SESSION['filter']['class'] == 'ik'){
                                        echo 'checked="checked"';
                                    } ?>/> IllusionKnight<br/>
                                <?php endif; ?>
                                <div style="margin:10px;display:block;width: 90%;text-align:center;">
                                    <button class="custom_button" type="submit" value="filter_items" name="filter_items"><?php echo __('Filter Items'); ?></button>
                                    <button class="custom_button" type="submit" value="reset_filter" name="reset_filter"><?php echo __('Reset Filter'); ?></button>
                                </div>
                            </form>
                        </div>
                    </div>
