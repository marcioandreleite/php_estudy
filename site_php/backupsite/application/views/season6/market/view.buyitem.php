                        ...
                        <form method="POST" action="" id="buy_item" name="buy_item">
                            ...
                            <table class="ranking-table">
                                ...
                                <tr>
                                    ...
                                    <td style="width:30%;text-align: left;padding-left: 15px;"><?php echo date(DATETIME_FORMAT, strtotime($this->Mmarket->item_info['add_date'])); ?></td>
                                </tr>
                                <tr>
                                    <td style="width:30%;text-align: left;padding-left: 15px;"><?php echo __('End Time'); ?>
                                        :
                                    </td>
                                    <td style="width:30%;text-align: left;padding-left: 15px;"><?php echo date(DATETIME_FORMAT, strtotime($this->Mmarket->item_info['active_till'])); ?></td>
                                </tr>
                                <tr>
