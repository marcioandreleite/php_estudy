                            ...
                            foreach($packages as $package){
                                ...
                                echo '<ul id="paypal-options">
									<li>
										...
										<a class="right custom_button" style="margin-top: 8px;" href="' . $this->config->base_url . 'donate/pagseguro/' . $package['id'] . '">' . __('Buy Now') . '</a>
									</li>
							</ul>';
                            }
                        } else{
                            echo '<div class="i_note">' . __('No PagSeguro Packages Found.') . '</div>';
                        }
                    }
                ?>
            </div>
