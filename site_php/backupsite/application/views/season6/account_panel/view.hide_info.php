...
<div id="content">
    <div id="box1">
                    ...
                    <tr>
                        ...
                        <td style="width:70%;text-align: left;padding-left: 15px;">
                            <?php
                                ...
                                echo $price; ?> <?php echo $this->website->translate_credits($this->config->config_entry('account|hide_char_price_type'), $this->session->userdata(['user' => 'server'])); ?>, <?php echo $this->config->config_entry('account|hide_char_days'); ?> <?php echo __('days'); ?>
                        </td>
                    </tr>
                    </tbody>
                </table>
		...
		<?php if(defined('ELITE_KILLER_HIDE') && ELITE_KILLER_HIDE == true){ ?>
		<div class="box-style1" style="margin-bottom: 20px;">
            <h2 class="title"><?php echo __('Hide PK Stats'); ?></h2>
            ...
            <div class="entry">
                <table class="ranking-table">
                    ...
                    <tr>
                        <td style="width:30%;text-align: left;padding-left: 15px;"><?php echo __('Hide Till'); ?></td>
                        <td style="width:70%;text-align: left;padding-left: 15px;"><?php echo $hide_time_pk; ?></td>
                    </tr>
                    <tr>
                        <td style="width:30%;text-align: left;padding-left: 15px;"><?php echo __('Hide Info'); ?></td>
                        <td style="width:70%;text-align: left;padding-left: 15px;"><?php echo __('Everyone can\'t see your character name in PK Statistics'); ?></td>
                    </tr>
                    <tr>
                        <td style="width:30%;text-align: left;padding-left: 15px;"><?php echo __('Hide Price'); ?></td>
                        <td style="width:70%;text-align: left;padding-left: 15px;">
                            <?php
                                ...
                                echo $price; ?> <?php echo $this->website->translate_credits(ELITE_KILLER_HIDE_PRICE_TYPE, $this->session->userdata(['user' => 'server'])); ?>, <?php echo ELITE_KILLER_HIDE_DAYS; ?> <?php echo __('days'); ?>
                        </td>
                    </tr>
                    </tbody>
                </table>
                <div style="text-align:center;">
                    <button class="custom_button" id="hide_chars_pk"><?php echo __('Hide Now'); ?></button>
                </div>
            </div>
        </div>
		<?php } ?>
