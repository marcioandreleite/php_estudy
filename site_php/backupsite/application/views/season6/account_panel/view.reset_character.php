            ...
            <div class="entry">
                <?php
                    if(isset($error)){
						...
						<div class="w_note">
							Vip reset price: <?php echo RESET_NORIA_VIP_PRICE;?> <?php echo $this->website->translate_credits(RESET_NORIA_VIP_PRICE_TYPE, $this->session->userdata(['user' => 'server']));?><br />
							Character will start with <?php echo RESET_NORIA_VIP_LVL_AFTER_RESET;?> level after reset.
						</div>
						<?php } ?>
